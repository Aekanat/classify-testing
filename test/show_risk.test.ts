...
const centerRiskThr = require('/Users/sunson/Desktop/Trainee/eval/center_thr_risk_dist.json');
const lowRiskThr = require('/Users/sunson/Desktop/Trainee/eval/low_thr_risk_dist.json');

describe('show risk endpoint.', () => {
    beforeEach(async () => {
        /**
    ...
    it('should return the risk when using center threshold probability', async () => {
        const response = await axios.get(`${BASE_URL}/risk_dist/?risk_thr=center_risk_probability_threshold`);
        /**
         * For testing every possible combination of risk sorted by Risk Level with Center Probability Threshold
         */
    ...
    it('should return the risk when using low threshold probability', async () => {
        /**
         * For testing every possible combination of risk sorted by Risk Level with Low Probability Threshold
         */
        const response = await axios.get(`${BASE_URL}/risk_dist/?risk_thr=low_risk_probability_threshold`);
